...
function startDetectionDrawing() {
    ...
    function startBeeping() {
        ...
        beepInterval = setInterval(() => {
            console.log(`🔊 Alarm check - personDetected: ${personDetected}, cameraActive: ${cameraActive}`);
            if (personDetected && cameraActive) {
                playBeep();
                console.log('🚨 ALARM BEEP: Person still detected in camera');
            } else {
                console.log('🔇 ALARM DEACTIVATED: Person left camera view or camera stopped');
                stopBeeping();
            }
